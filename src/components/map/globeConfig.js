...
// Alidade Satellite: imagem de satélite/aérea com labels e contornos por cima.
// https://docs.stadiamaps.com/map-styles/alidade-satellite/
const STADIA_STYLE_ID = 'alidade_satellite';

// A key vem de EXPO_PUBLIC_STADIA_API_KEY. Em localhost e nos domínios autorizados
// no painel da Stadia ela é opcional; fora deles a style/tiles retornam 401.
...
// Fundo escuro atrás do globo — recomendado pela Stadia para dar contraste e
// leitura melhor da esfera contra o "espaço". As estrelas entram por cima dele
// (ver starfield.js).
